...
function InertiaWord({
  ...
  return (
    <motion.span
      aria-hidden="true"
      className={`inline-block cursor-default select-none will-change-transform ${wordClassName || ""}`}
...
export default function TextInertia({
  ...
  return (
    <div
      className={`flex flex-wrap items-center justify-center gap-x-[0.35em] gap-y-[0.12em] text-center leading-none ${className || ""}`}
